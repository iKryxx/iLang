...
statement: (assignment | functionCall | functionAssignment | return) ';'; //whats a statement? its either an assignment or a function Call, followed by a semicolon
...
constant: INT | FLOAT | STRING | BOOL | NULL;
